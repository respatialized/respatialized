/* An extremely simple extension of the Clojure ANTLR grammar to support pollen-like markup for s-expressions */

grammar ETN;

file: etn_text EOF;

etn_text: (loz_form | plaintext) *;

loz_form: lozenge form;
