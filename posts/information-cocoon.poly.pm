...
◊(define-meta title "Reifying the Filter Bubble")
◊(define-meta published "2019-05-24")
◊(define-meta topics "infrastructure,speculation,climate")
◊c[#:span "1-3" #:span-s "row"]{◊section{Making the metaphor concrete}
...
◊link["https://grist.org/article/5g-networks-could-throw-weather-forecasting-into-chaos/"]{Grist reports:} "On Capitol Hill Thursday, NOAA’s acting chief, Neil Jacobs, said that interference from 5G wireless phones could reduce the accuracy of forecasts by 30 percent."
...
} ◊c[#:span "4-6" #:span-s "row"]{◊section{A Likely Scenario}
