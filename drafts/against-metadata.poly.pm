...
◊(define-meta title "Against Metadata")
◊(define-meta published "2019-08-16")
◊(define-meta topics "programming")
...
But the ◊emph{data}, the ◊emph{real stuff}, out of which the photograph is composed, only has meaning due to us. This might seem obvious, but I think it has important consequences. Why did I write this? Because I don't like YAML. YAML is designed for metadata, and metadata alone. But now it does a lot more than what was initially asked of it. It was originally used to ◊emph{describe}; now it is expected to ◊emph{perform}. What was once "Yet Another Markup Language" is now "YAML ain't markup language." 
